...
public class OrderBLServiceTest {
	...
	public void testReviewOrder() {
		orderBlService = new OrderBLService_Stub(userID, setTime, checkIn, checkOut, roomNumber, hotelID, rooms);
	...
	public void testComplainOrder() {
		orderBlService = new OrderBLService_Stub(userID, setTime, checkIn, checkOut, roomNumber, hotelID, rooms);
		assertEquals(ResultMessage.TRUE, orderBlService.complainOrder(orderVO));
	}
